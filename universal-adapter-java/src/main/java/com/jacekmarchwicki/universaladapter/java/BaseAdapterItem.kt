 ...
 * the License.
 */
package com.jacekmarchwicki.universaladapter.java
...
interface BaseAdapterItem {
     ...
     *
     * Usually it means booth items has same id
     *
     ...
     *
     * Usually it means both items has same id, name and other fields
     *
     * If you implemented [Object.equals] you can call
     * `this.equals(item)`
     *
     * @param item to compare
